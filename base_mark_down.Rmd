...
```
Student 1 has average daily step between 11087 to 11161, 95% chance, credible intervals
...
To estimate the average daily step of graduate students, we need to calculate posterior mean
Student 1's daily step counts are greater than posterior mean which is assumed as the population standard
